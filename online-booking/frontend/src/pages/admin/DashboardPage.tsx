          ...
          <div className="dashboard-grid">
            <div className="card"><h3>Статусы записей</h3>
              <div className="status-list">
                ...
                {Object.keys(stats.status_counts).length === 0 && <EmptyState icon="📅" title="Нет записей" description="Записи появятся после бронирования" />}
              </div>
            </div>
            <div className="card">
              ...
              <div className="appointment-list">
                ...
                {(!stats.recent_appointments || stats.recent_appointments.length === 0) && <EmptyState icon="📭" title="Нет записей" description="Ближайшие записи появятся здесь" />}
              </div>
            </div>
          </div>
        </>
